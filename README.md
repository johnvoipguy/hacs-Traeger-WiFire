...
3. In the `custom_components` directory (folder) create a new folder called `traeger-hacs`.
4. Download _all_ the files from the `custom_components/traeger-hacs/` directory (folder) in this repository.
